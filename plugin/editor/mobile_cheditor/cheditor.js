...
var GB = {
    ...
    popupWindow: {
        ColorPicker :   {tmpl : 'color_picker.html',    width : 295, title : '색상 선택'},
        Embed :         {tmpl : 'media.html',           width : 295, title : '미디어'},
        EmotionIcon :   {tmpl : 'icon.html',            width : 295, title : '표정 아이콘'},
        FlashMovie :    {tmpl : 'flash.html',           width : 295, title : '플래쉬 동영상'},
        GoogleMap :     {tmpl : 'google_map.html',      width : 295, title : '구글 지도'},
        ImageUpload :   {tmpl : 'image.html',           width : 295, title : '내 PC 사진 넣기'},
        ImageUrl :      {tmpl : 'image_url.html',       width : 295, title : '웹 사진 넣기'},
        Layout :        {tmpl : 'layout.html',          width : 295, title : '레이아웃'},
        Link :          {tmpl : 'link.html',            width : 295, title : '하이퍼링크'},
        ModifyTable :   {tmpl : 'table_modify.html',    width : 295, title : '표 고치기'},
        Symbol :        {tmpl : 'symbol.html',          width : 295, title : '특수 문자'},
        Table :         {tmpl : 'table.html',           width : 295, title : '표 만들기'}
    },
    fontName: {
...
function setConfig() {
    var config = {
        ...
        imgCaptionFigure    : 'border: 0px #ccc solid; background-color: #fff; margin: 0;color:#999;text-align:left',
        imgCaptionText      : 'margin: 10px 0px 10px 0px; text-align: left; line-height: 18px; font-size: 12px; letter-spacing: -0.04em; text-align:justify;',
        imgCaptionWrapper   : '',
        imgDefaultAlign     : 'left',   // [left, center, right]
        imgJpegQuality      : 1,     // JPEG 사진의 퀄리티 값, 최대값 1
        imgMaxWidth         : 360,      // 사진 최대 가로 크기, 이 크기 보다 크면 리사이징 처리
        imgResizeMinLimit   : 32,       // 사진 리사이징의 사용자 직접 입력 값이 이 값 보다 작으면, 이 값으로 설정
        imgResizeSelected   : 360,      // 사진 리사이징의 선택 입력 폼의 기본 선택 값
        imgResizeValue      : [120, 240, 360, 640, 780, -1], // -1 = 사용자 직접 입력
        imgSetAttrAlt       : true,
        ...
        if (!(this.undefined(GB.popupWindow[popupName]))) {
            ...
            if (popupName === 'ImageUpload' && window.File && window.FileReader && window.FileList && window.Blob) {
                if (this.browser.mobile) {
                    ...
                    popup.width = 295; // 팝업 윈도우 가로 폭 크기(px)
                } else {
