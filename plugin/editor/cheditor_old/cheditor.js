...
function setConfig() {
    var config = {
        ...
        editorBgColor       : '#fff',
        editorFontColor     : '#000',
        editorFontName      : '"Nanum Gothic","나눔고딕","맑은 고딕", "Malgun Gothic", gulim',
        editorFontSize      : '16px',
        editorHeight        : '300px',
        editorPath          : null,
        editorWidth         : '100%',
        ...
        imgMaxWidth         : 875,      // 사진 최대 가로 크기, 이 크기 보다 크면 리사이징 처리
        imgResizeMinLimit   : 32,       // 사진 리사이징의 사용자 직접 입력 값이 이 값 보다 작으면, 이 값으로 설정
        imgResizeSelected   : 875,      // 사진 리사이징의 선택 입력 폼의 기본 선택 값
        imgResizeValue      : [120, 240, 320, 660, 875, -1], // -1 = 사용자 직접 입력
        imgSetAttrAlt       : true,
