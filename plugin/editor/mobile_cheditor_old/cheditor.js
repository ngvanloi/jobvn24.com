...
var GB = {
    ...
    popupWindow: {
        ColorPicker :   {tmpl : 'color_picker.html',    width : (mobile_is) ? 295 : 420, title : '색상 선택'},
        Embed :         {tmpl : 'media.html',           width : (mobile_is) ? 295 : 430, title : '미디어'},
        EmotionIcon :   {tmpl : 'icon.html',            width : (mobile_is) ? 295 : 300, title : '표정 아이콘'},
        FlashMovie :    {tmpl : 'flash.html',           width : (mobile_is) ? 295 : 584, title : '플래쉬 동영상'},
        GoogleMap :     {tmpl : 'google_map.html',      width : (mobile_is) ? 295 : 538, title : '구글 지도'},
        ImageUpload :   {tmpl : 'image.html',           width : (mobile_is) ? 295 : 700, title : '내 PC 사진 넣기'},
        ImageUrl :      {tmpl : 'image_url.html',       width : (mobile_is) ? 295 : 350, title : '웹 사진 넣기'},
        Layout :        {tmpl : 'layout.html',          width : (mobile_is) ? 295 : 430, title : '레이아웃'},
        Link :          {tmpl : 'link.html',            width : (mobile_is) ? 295 : 350, title : '하이퍼링크'},
        ModifyTable :   {tmpl : 'table_modify.html',    width : (mobile_is) ? 295 : 430, title : '표 고치기'},
        Symbol :        {tmpl : 'symbol.html',          width : (mobile_is) ? 295 : 450, title : '특수 문자'},
        Table :         {tmpl : 'table.html',           width : (mobile_is) ? 295 : 430, title : '표 만들기'}
    },
    fontName: {
