	...
	<section>
		...
		<div class="consadmin conbox">
			<div class="guide">
				...
				<ul>
					<li>- 개인회원들의 구인공고 스크랩 현황을 관리하시는 페이지 입니다.</li>
				</ul>
			</div>
			...
			<h6>구인공고 스크랩 관리<span>총 <b><?php echo number_format(intval($_arr['total']));?></b>건이 검색되었습니다.</span>
				<p class="h6_right">
			...
			<table class="table4">
				...
				<thead>
					<tr>
						...
						<th>회원구분</th>
						<th>회원정보</th>
						<th colspan="2">스크랩한 구인(정규직)공고</th>
						<th>스크랩일</th>
						<th>편집</th>
					</tr>
				</thead>
