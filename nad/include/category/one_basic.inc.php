<tr align="center">
	...
	<td><input type="checkbox" value="<?php echo $row['no'];?>" name="view[]" onClick="nf_category.view(this)" <?php echo $row['wr_view'] ? 'checked' : '';?>></td>
	...
	<td><button type="button" class="gray common" onclick="nf_util.ajax_post(this, '삭제하시겠습니까?')" no="<?php echo $row['no'];?>" mode="delete_category" para="wr_type=<?php echo $row['wr_type'];?>" url="../regist.php"><i class="axi axi-minus2"></i> 삭제</button></td>
</tr>