			...
			<table class="table4">
				...
				<tbody>
					...
					<tr class="tac" mb_id="<?php echo $mem_row['mb_id'];?>">
						...
						<td><?php echo $nf_util->get_text($mem_row['mb_name']);?> (<?php echo $nf_util->gender_arr[$mem_row['mb_gender']];?>/<?php echo $nf_util->get_age($mem_row['mb_birth']);?>세)</td>
						<td><?php echo $nf_util->get_text($mem_row['mb_nick']);?></td>
						<td><?php echo intval($mem_row['mb_point']);?></td>
						<td><a href="<?php echo NFE_URL;?>/nad/job/resume.php?mno=<?php echo $mem_row['no'];?>" class="blue fwb"><?php echo intval($resume_int['c']);?></a></td>
						<td><?php echo intval($accept_int['c']);?></td>
						<td>
