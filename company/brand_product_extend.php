...
<div class="m_title">
	<button class="back" onclick="history.back()"><i class="axi axi-keyboard-arrow-left"></i></button>브랜드 입점 연장<button class="forward" onclick="history.forward()"><i class="axi axi-keyboard-arrow-right"></i></button>
</div>
			...
			<section class="brand_product service">
				<h4>브랜드 입점 연장</h4>
				 <div class="current_status">
					<p>현재 <b>[2022.04.14 ~ 2022.05.14 / 진행중인 구인공고 : <span class="orange">50건</span>]</b>사용중 입니다.</p>
					<p><b class="orange">* 50건 이상의 상품만 구매 가능</b>합니다. 연장하는 서비스는 <em>2022.05.15 이후에 적용</em>됩니다.</p>
				 </div>
				<div class="tablewrap">
						...
						<tr>
							<td>
								...
								<ul class="product_info">
									<li>상품 기간 만료시점에서 1개월 전부터 연장할 수있습니다. </li>
									<li><b>상품 연장내역이 유효할 경우, 건수를 추가 구매할 수 없습니다. 연장하시기 전에, 현재 이용중인 건수를 신중히 생각하시고 연장 구매하시기 바랍니다.</b> <br><span class="bojo">	- 예) 3월달에 100건의 상품을 이용중일때, 1개월 100건을 추가 연장하시면, 3월달에는 건수를 추가하지 못합니다. 4월달이 되고 더이상의 연장건이 없을때 건수 추가가 가능합니다.</span></li>
				...
				<div class="payment register ">
					<div class="payment_box">
						...
						<table class="style2 tac">
							...
							<tr>
								<td>브랜드 입점 연장</td>
								<td class="tal">1개월 (2022.05.15 ~ 2022.06.15) / 100건</td>
