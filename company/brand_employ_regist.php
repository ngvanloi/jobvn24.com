...
<div class="m_title">
	<button class="back" onclick="history.back()"><i class="axi axi-keyboard-arrow-left"></i></button>브랜드 구인공고 등록<button class="forward" onclick="history.forward()"><i class="axi axi-keyboard-arrow-right"></i></button>
</div>
<div class="wrap1260 MAT20">
	<section class="employ_regist regist_common sub">
		<div class="left_info">
				...
				<div class="common_box">
					<table class="com_table">	
						<tr>
							...
							<td>
								<ul class="logotype">
									<li><input type="radio" id="logotype1" name="logo"><label for="logotype1" class="radiostyle1" ></label> 업소명 텍스트사용(로고사용안함)</li>
									<li><input type="radio" id="logotype2" name="logo"><label for="logotype2" class="radiostyle1" ></label> 로고사용 <button>로고등록</button>
										<div class="logo_box">
											
										</div>
									</li>
									<li><input type="radio" id="logotype3" name="logo"><label for="logotype3" class="radiostyle1" ></label> 배경로고사용 <button>배경등록</button>
										<div class="bg_box">
				...
				<div class="common_box">
					<table class="com_table">
						...
						<tr class="resume">
							<th>이력서</th>
							<td>
								<input type="checkbox" id=""><label for="" class="checkstyle1" ></label> 자사양식 사용
								<p class="MAT10"><input type="file"></p><!--자사양식 사용 체크시 노출-->
							</td>
						</tr>
						<tr>
							<th>제출서류</th>
			...
			<div class="manager box_wrap">
				...
				<div class="common_box">
					<table class="com_table">
						<tr class="chain">
							<th><i class="axi axi-ion-android-checkmark"></i>체인지점명</th>
							<td>
								<p class="bojotext">* 체인지점 목록이 없으면 직접 입력해주세요.</p>
								<ul class="li_float">
									<li><input type="radio" id=""><label for="" class="radiostyle1" ></label>
										<select name="" id="">
											<option value="">체인지점선택</option>
											<option value="">광주광역시 화정지점</option>
										</select>
									</li>
									<li><input type="radio" id=""><label for="" class="radiostyle1" ></label><input type="text" placeholder="직접입력"></li>
								</ul>
							</td>
						</tr>
						<tr>
			...
			<div class="guide box_wrap">
				...
				<div class="common_box">
					<ul>
						<li class="on"><a href=""><img src="../images/skin1.png" alt="스킨1"></a></li>
		...
		<div class="right_info">
			...
			<button class="base">심사 후 공고등록완료</button>
...
<div class="popup_layer ijimg" style="display:none;">
	<h1>로고등록/수정<button><i class="axi axi-ion-close-round"></i></button></h1>
	<div class="text_info">
		GIF, JPEG, JPG, PNG 파일형식으로 140*120픽셀, 100KB 용량 이내의 파일을 권장합니다.
	</div>
	<p class="file">
		<input type="file">
	</p>
...
<div class="popup_layer ijimg" style="display:none;">
	...
	<div class="text_info">
		GIF, JPEG, JPG, PNG 파일형식으로 401*168픽셀, 100KB 용량 이내의 파일을 권장합니다.
	</div>
	<p class="file">
		<input type="file">
	</p>
...
<div class="popup_layer help" style="display:none;" >
...
<div class="popup_layer welfare" style="display:none;">
...
<div class="popup_layer rank" style="display:none;">
