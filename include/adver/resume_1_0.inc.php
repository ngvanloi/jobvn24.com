<section class="focus">
	<div class="product_title">
		<p><?php echo $nf_job->service_name['resume']['sub'][0];?> 인재정보</p>
	...
	<div class="focus_wrap injae_wrap">
		<ul>
			...
			for($i=0; $i<$service_arr['list_limit']; $i++) {
				...
				$bordercolor = $re_row['wr_service1_border']>=today ? 'bordercolor' : '';
				$bordercolor_val = $re_row['wr_service1_border']>=today ? $env['service_config_arr']['resume'][$arr['service_k']]['border_strong_color'] : $env['service_config_arr']['resume'][$arr['service_k']]['border_color'];
				...
				<a href="<?php echo NFE_URL;?>/resume/resume_detail.php?no=<?php echo $re_row['no'];?>">
					<div class="toparea">
						<div class="textarea">
							...
							<p class="myinfo line1"><?php echo $re_info['name_txt'];?> <span><?php echo $re_info['gender_age_txt'];?></span> <em>/ <?php echo $re_info['career2_txt'];?></em></p>
							<p class="title line2 <?php echo $re_info['bold_text'].$re_info['blink_text'];?>" style="<?php echo $re_info['neon_text'].$re_info['color_text'];?>"><?php echo $re_info['icon_text'];?><?php echo $nf_util->get_text($re_row['wr_subject']);?></p>
						</div>
						<div class="photo">
							<p style="background-image:url(<?php echo $re_info['photo_src'];?>)"></p>
						</div>
					</div>
					<div class="bottomarea">
						<p class="injae_icon line1">
							<?php
							echo $re_info['icon_focus1'];
							?>
						</p>
			...
			<li class="noproduct" style="border-color:<?php echo $bordercolor_val;?> !important">
				<a href="<?php echo NFE_URL;?>/service/index.php?code=resume&#service_loc_resume_<?php echo $arr['service_k'];?>">
					<div>
						<p><?php echo $nf_job->service_name['resume']['main'][0];?> 인재 등록</p>
