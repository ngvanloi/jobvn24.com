<section>
	<div class="product_title">
		<p><?php echo $nf_job->service_name['employ']['main'][3];?> 구인정보</p>
		<?php if($env['service_employ_use']) {?><span><a pref="<?php echo NFE_URL;?>/service/index.php?#service_loc_employ_<?php echo $arr['service_k'];?>">상품안내</a></span><?php }?>
	</div>
	<?php
	...
	<div class="banner_list">
		<ul class="num<?php echo intval($service_arr['limit_arr'][0]);?>">
			...
			for($i=0; $i<$service_arr['list_limit']; $i++) {
				...
				if($em_row) {
			?>
			<li class="common <?php echo $bordercolor;?>" style="border-color:<?php echo $bordercolor_val;?> !important;">
				<a href="<?php echo NFE_URL;?>/employ/employ_detail.php?no=<?php echo $em_row['no'];?>">
					...
					<div class="textarea">
						...
						<p class="title line1 <?php echo $em_info['bold_text'].$em_info['blink_text'];?>" style="<?php echo $em_info['neon_text'].$em_info['color_text'];?>"><?php echo $em_info['icon_text'];?><?php echo $nf_util->get_text($em_row['wr_subject']);?></p>
						<div class="asi_wrap">				
							<p class="date line1 bgcol1"><?php echo $em_info['end_date'];?></p>
							<p class="location line1"><?php echo $em_info['area_text_arr2'][0][1];?> · <?php if($em_info['pay_txt_first']) {?><span class="<?php echo $nf_job->pay_price_css2[$em_info['pay_txt_first']];?>"><?php echo $em_info['pay_txt_first'];?></span><?php }?> <?php echo $em_info['pay_txt_price'];?>
							</p>
						</div>
					</div>
				</a>
			...
			<li class="common noproduct" style="border-color:<?php echo $bordercolor_val;?> !important;">
				<a href="<?php echo NFE_URL;?>/service/index.php?#service_loc_employ_<?php echo $arr['service_k'];?>">
					<div>
						<p><?php echo $nf_job->service_name['employ']['main'][3];?> 구인 등록</p>
