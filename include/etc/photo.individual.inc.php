...
<input type="hidden" name="mode" value="resume_photo_upload" />
...
<div class="popup_layer ijimg">
	...
	<div class="text_info">
		GIF, JPEG, JPG, PNG 파일형식으로 140*170픽셀, 100KB 용량 이내의 파일 등록을 권장합니다.
	</div>
	<p class="file">
		<input type="file" name="file_upload" hname="사진" needed id="file_upload-" />
		<?php if($member_ex['is_photo']) {?><button type="button" onClick="nf_member.delete_my_photo()" style="border:1px solid #d5d5d5; padding:5px; margin-left:5px;">파일삭제</button><?php }?>
	</p>
	<ul class="btn">
